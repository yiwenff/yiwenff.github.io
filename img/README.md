...
| `work-spatiotemporal-analysis.png` | **Merged** — American Cordillera domains (left) and the windward/leeward panels (right), *TC* 2023 Figs. 1 and 5 | index | **done** |
...
Yiwen merged the two index figures into one on 2026-09-13; the site uses the merged file only.
`paper-wna-windward.png` moved to `img/_originals/`. The merged file still carries CC BY 4.0 material
from *The Cryosphere* **17**, 5175 (2023), so keep the credit line under that entry.
